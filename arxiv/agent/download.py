...
if __name__ == "__main__":
    link = "https://github.com/bitMyron/sa-swin/tree/main/datasets"
    ...
    if link.startswith("https://github.com/"):
        ...
        # 提取 folder_path
        folder_path = parts[-1]
        print(repo_url, folder_path)

    dest_dir = "/Users/zhijingsun/Downloads/sa-swin-datasets"  # 想要下载文件到的本地目录
