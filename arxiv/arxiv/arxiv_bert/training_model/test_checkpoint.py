...
if __name__ == "__main__":
    ...
    # Test the model for each checkpoint
    for checkpoint_dir in checkpoint_dirs:
        epoch = checkpoint_dir.split('-')[-1]
        model_save_path = os.path.join(results_dir, checkpoint_dir)
        test_model(test_dataset, tokenizer, model_save_path, epoch)
    
    model_save_path = f'./fine_tuned_model'
