...
# 从JSON文件中读取数据
with open('/Users/zhijingsun/Desktop/东理/arxiv/arxiv/arxiv/arxiv_bert/training_data/augmentation_data/0802.json', 'r') as f: 
    data = json.load(f)
...
MODEL_NAME = "/Users/zhijingsun/Desktop/东理/基础模型/0731" # 之前训练好的模型
...
def train_model():
    ...
    model_save_path = os.path.expanduser('~/Desktop/东理/基础模型/802')
